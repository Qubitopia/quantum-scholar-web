...
const styles = {
    ...
    navbarLoginHover: { whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
        toggleBtn: { width: 40, height: 40, borderRadius: 999, border: '1px solid var(--border)', background: 'transparent', color: 'var(--text)' },
    ...
    return (
        <>
            <header style={styles.navbar}>
                ...
                {/* Mobile toggle */}
                <button aria-label="Menu" onClick={toggle} className="inline-flex items-center justify-center md:hidden" style={styles.toggleBtn}>
            ...
            {/* Mobile menu */}
            {open && (
                <nav className="md:hidden" style={styles.mobileMenu}>
